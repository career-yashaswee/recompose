        ...
        <CardContent>
          <Tabs defaultValue="all" className="space-y-4">
            ...
            <TabsContent value="earned" className="space-y-4">
              <BadgeGrid
                badges={filteredBadges.filter((badge) => badge.userProgress.isEarned)}
            ...
            <TabsContent value="progress" className="space-y-4">
              <BadgeGrid
                badges={filteredBadges.filter(
                  (badge) => !badge.userProgress.isEarned && badge.userProgress.progress > 0
                )}
                isLoading={badgesLoading}
              />
            </TabsContent>
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <BadgeComponent variant="outline">
                    {categoryBadges.filter((b) => b.userProgress.isEarned).length}/
