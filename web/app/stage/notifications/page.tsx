...
const mockNotifications: Notification[] = [
  {
    ...
    metadata: { compositionId: "comp-123", compositionTitle: "Daily Writing Practice" }
  },
  {
    id: "2",
    type: "info",
  ...
  },
  {
    ...
    type: "warning",
    title: "Reminder",
    message: "Don't forget to complete today's writing practice to maintain your streak.",
    timestamp: "2d ago",
    isRead: true,
    category: "system"
  },
...
export default function NotificationsPage() {
  ...
  const [activeTab, setActiveTab] = useState<"all" | "unread" | "system" | "composition">("all");
  ...
  const compositionCount = notifications.filter(n => n.category === "composition").length;
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    if (activeTab === "composition") return notification.category === "composition";
    return true;
  });
  ...
  const getNotificationIcon = (type: Notification["type"]) => {
    switch (type) {
      ...
      case "warning":
        return <div className="h-4 w-4 rounded-full bg-yellow-500 flex items-center justify-center text-white text-xs font-bold">!</div>;
      case "error":
        return <div className="h-4 w-4 rounded-full bg-red-500 flex items-center justify-center text-white text-xs font-bold">!</div>;
      default:
        return <div className="h-4 w-4 rounded-full bg-blue-500 flex items-center justify-center text-white text-xs font-bold">i</div>;
    }
  };
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Login, updates, reminders</p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium">Composition Notifications</p>
                  <p className="text-xs text-muted-foreground">Completion, progress updates</p>
                </div>
                <Switch
                  checked={settings.compositionNotifications}
                  onCheckedChange={(checked) => 
                    setSettings(prev => ({ ...prev, compositionNotifications: checked }))
                  }
                />
              </div>
            </CardContent>
