...
export function UserProfile({ className }: UserProfileProps): React.ReactElement {
  ...
  return (
    <div className={`w-80 bg-gray-50 rounded-lg p-6 space-y-6 ${className || ""}`}>
      {/* Profile Header */}
      <div className="relative">
        <div className="bg-gradient-to-r from-pink-400 to-pink-600 rounded-lg h-24 flex items-center justify-center">
          <Avatar className="w-16 h-16 border-4 border-white">
            <AvatarImage src={user.image || "https://ui.shadcn.com/placeholder.svg"} alt={user.name || "User"} />
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">
              78 Maple Drive, New York, NY, USA
            </span>
          </div>
        </div>
      </div>
